            ...
            if(req.body.address && req.body.message && req.body.signature && req.body.star) {
                ...
                try {
                    ...
                    if(block){
                        ...
                        console.log("Could not create the block 1");
                        return res.status(500).send("Could not create the block");
                    }
                } catch (error) {
                    console.log("Could not create the block 2");
                    return res.status(500).send(error);
                }
            } else {
                console.log("Could not create the block 3");
                return res.status(500).send("Check the Body Parameter!");
            }
        });
    }
